    ...
    <div className="container py-4">
      <div className="mb-3">
        <nav className="breadcrumb">
          <span className="breadcrumb-item" style={{ cursor: 'pointer' }} onClick={() => window.history.back()}>Home</span>
          <span className="breadcrumb-item active">{company.name}</span>
        </nav>
      </div>
          ...
          <div className="p-3 border rounded shadow-sm">
            ...
            {company.facebook && (
              <p className="mb-2">
                ...
                <a href={company.facebook} target="_blank" rel="noreferrer">{company.facebook}</a>
              </p>
            )}
            {company.instagram && (
              <p className="mb-2">
                <FaInstagram className="me-2 text-secondary" />
                <a href={company.instagram} target="_blank" rel="noreferrer">{company.instagram}</a>
              </p>
            )}
            {company.twitter && (
              <p className="mb-2">
                <FaTwitter className="me-2 text-secondary" />
                <a href={company.twitter} target="_blank" rel="noreferrer">{company.twitter}</a>
              </p>
            )}
            {company.linkedin && (
              <p className="mb-2">
                <FaLinkedinIn className="me-2 text-secondary" />
                <a href={company.linkedin} target="_blank" rel="noreferrer">{company.linkedin}</a>
              </p>
            )}
            <p className="mb-0">
